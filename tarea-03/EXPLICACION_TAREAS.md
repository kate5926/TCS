...
El proyecto está distribuido en 3 capas físicamente independientes:

```
┌─────────────────────┐
│      FRONTEND        │   Vue 3 + Vite + vue-router
│  (Presentación / UI)  │   Sidebar + 3 vistas (Inicio, Placas, Conductores)
└──────────┬───────────┘
           │ HTTP (axios)
┌──────────▼───────────┐
│       BACKEND         │   Express
...
│       │                │
│       ▼                │
│  services/     ──────► │  validan y aplican reglas de negocio
│       │                │
│       ▼                │
